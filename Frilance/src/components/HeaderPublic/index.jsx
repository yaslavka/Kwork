...
function HeaderPublic() {
  ...
  return (
    <>
      ...
      <div
        className={
          'header relative header-new js-header-new js-header-mobile is_index out-3 header-unauthorized header-unfixed'
        }>
                ...
                <div className='search'>
                  <div id='general-search'>
                    <div className='custom-search general-search'>
                      ...
                      <div
                        className='dropdown dropdown-suggestions dropdown-suggestions-header'
                        style={{ display: 'none' }}>
        ...
        <div className={'subnav subnav--new'}>
          <div className={'centerwrap lg-centerwrap category-menu category-menu--new'}>
            <ul
              className={
                'js-category-menu-list js-cat-menu-thin category-menu__list subnav__category-menu cat-menu-thin sub-menu-parent'
              }>
              {listItem && (
                <>
